<?php
    ...
    echo "<ul id='lista_principal_index'>
            <li id='inicio'><a href='inicio' title='Inicio'><img src='./views/default/img/logos/TheFantasticL.png' alt='The Fantastic L'/></a></li>";
...
//     }
    ...
    if (strpos($_SERVER['REQUEST_URI'], "campaign") !== false) {
        // campaign.php found
        echo "<li id='campaign'><a href='campaign' title='Campaign Management' class='seleccionado'>Campaign Management</a></li>";
    } else {
        echo "<li id='campaign'><a href='campaign' title='Campaign Management'>Campaign Management</a></li>";
    }
    ...
    echo "<li id='menu_moviles'><i class='fa fa-bars' aria-hidden='true'></i></a>
            <ul id='lista_movil'>
                ...
                <li id='campaign2'><a href='campaign' title='Campaign Management'>Campaign Management</a></li>
                <li id='contacto2'><a href='contacto' title='Contacto'>Contacto</a></li>
                <li id='blog2'><a href='blog' title='Blog'>Blog</a></li>
            </ul>
        </li>
        <li id='idioma'><img class='bandera espanola' src='./views/default/img/banderas/Spain.png' alt='Español' title='Español'/><img class='bandera inglesa' src='./views/default/img/banderas/United-Kingdom.png' alt='Inglés' title='Inglés'/></li>
