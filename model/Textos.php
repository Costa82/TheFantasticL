...
//         $sql = "SELECT t.*, ti.* FROM textos t, textos_ingles ti WHERE t.id_texto = ti.id_texto AND t.cod_tipo_texto = '" . $cod_tipo_texto . "' AND t.cod_estado = 'ACTV'";
        
//         if ($this->db->real_query($sql)) {
//             if ($resul = $this->db->store_result()) {
//                 if ($resul->num_rows > 0) {
...
//             }
//         } else {
//             echo $this->db->errno . " -> " . $this->c->error;
//         }
    }
